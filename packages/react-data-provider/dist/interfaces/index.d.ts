...
export type PostRequestOptions<TRequestBody = unknown> = Omit<RequestParams, 'method'> & {
    body?: TRequestBody;
};
export type GetRequestOptions = Omit<RequestParams, 'method'>;
export type PutRequestOptions<TRequestBody = unknown> = Omit<RequestParams, 'method'> & {
    body?: TRequestBody;
};
export type PatchRequestOptions<TRequestBody = unknown> = Omit<RequestParams, 'method'> & {
    body?: TRequestBody;
};
...
export type AsyncReturnType<T extends (...args: any) => Promise<unknown>> = T extends (...args: any) => Promise<infer R> ? R : unknown;
...
export interface DataProviderRequestOptions<TQueryFnData = unknown, TError = unknown> {
