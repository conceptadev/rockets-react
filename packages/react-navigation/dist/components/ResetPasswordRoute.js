...
const ResetPasswordRoute = ({ home, moduleProps }) => {
    ...
    return (react_1.default.createElement(react_material_ui_1.AuthModule, Object.assign({ route: "resetPassword", signInPath: "/sign-in", query: {
