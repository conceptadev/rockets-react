...
const ModalFormSubmodule = (props) => {
    ...
    return (react_1.default.createElement(material_1.Dialog, { open: isVisible, maxWidth: "md", fullWidth: true, onClose: onClose, sx: sx, id: "Rockets-FormDialog", className: "Rockets-FormDialog" },
        ...
        react_1.default.createElement(material_1.DialogContent, null, isLoading ? (react_1.default.createElement(material_1.Box, { sx: {
                display: 'flex',
                justifyContent: 'center',
                alignItems: 'center',
                my: 10,
            } },
            react_1.default.createElement(material_1.CircularProgress, null))) : (react_1.default.createElement(SchemaForm_1.SchemaForm.Form, Object.assign({ schema: Object.assign(Object.assign({}, formSchema), { required: (formSchema === null || formSchema === void 0 ? void 0 : formSchema.required) || [], properties: (formSchema === null || formSchema === void 0 ? void 0 : formSchema.properties) || {}, title: '' }), uiSchema: formUiSchema, validator: validator_ajv6_1.default, onSubmit: handleFormSubmit, noHtml5Validate: true, showErrorList: false, formData: fieldValues, widgets: _widgets, onChange: handleFieldChange, customValidate: customValidate, readonly: viewMode === 'details' }, otherProps),
            children,
            react_1.default.createElement(material_1.Box, { display: "flex", flexDirection: "row", alignItems: "center", justifyContent: viewMode === 'creation' ? 'flex-end' : 'space-between', mt: 4 },
                ...
                react_1.default.createElement(material_1.Box, { display: "flex", flexDirection: "row", alignItems: "center", mt: 2, gap: 2 },
...
exports.default = ModalFormSubmodule;
