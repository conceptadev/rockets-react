...
export type FormSubmoduleProps = PropsWithChildren<Omit<SchemaFormProps, 'schema' | 'uiSchema' | 'validator' | 'noHtml5Validate' | 'showErrorList' | 'formData' | 'readonly' | 'customValidate'>> & {
    isVisible: boolean;
