...
const TableOptions = ({ row, customRowOptions, toggleDirection = 'horizontal', }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Tooltip_1.default, { title: "Options" },
            react_1.default.createElement(IconButton_1.default, { id: "fade-button", "data-testid": "fade-button", "aria-controls": open ? 'fade-menu' : undefined, "aria-haspopup": "true", "aria-expanded": open ? 'true' : undefined, onClick: handleClick }, toggleDirection === 'horizontal' ? (react_1.default.createElement(MoreHoriz_1.default, null)) : (react_1.default.createElement(MoreVert_1.default, null)))),
        react_1.default.createElement(Menu_1.default, { id: "fade-menu", "data-testid": "fade-menu", MenuListProps: {
